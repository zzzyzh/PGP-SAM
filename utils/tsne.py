...
#             sam_prototype_feats, _, _ = model.prototype_prompt_encoder(image_embeddings)

#             tsne_runner.input2basket(sam_prototype_feats, masks.squeeze(1).to(torch.long), dataset_name)  
