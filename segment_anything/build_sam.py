...
from .ppm import HierMaskDecoder, TwoWayTransformer


def build_sam_vit_h(checkpoint=None, model_type=None, image_size=512, num_classes=9):
    if model_type:
...
def build_sam_vit_l(checkpoint=None, model_type=None, image_size=512, num_classes=9):
    if model_type:
        return _build_lora_sam_hier(
            model_type=model_type,
...
def build_sam_vit_b(checkpoint=None, model_type=None, image_size=512, num_classes=9):
    if model_type:
        return _build_lora_sam_hier(
            model_type=model_type,
...
def _build_lora_sam_hier(
    ...
    return image_encoder, mask_decoder
